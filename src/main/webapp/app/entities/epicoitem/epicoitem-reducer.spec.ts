...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './epicoitem.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EPICOITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_EPICOITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EPICOITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EPICOITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EPICOITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EPICOITEM actions', async () => {
      const expectedActions = [
        {
